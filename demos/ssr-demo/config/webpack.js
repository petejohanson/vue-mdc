...
module.exports = function ({mode, env, publicPath}) {
  ...
  return {
      ...
      rules: [
        {
          ...
          loader: 'vue-loader',
          options: {
		  loaders: !isDev ? { css: ExtractTextPlugin.extract({loader: 'css-loader'}), sass: ExtractTextPlugin({loader: 'sass-loader' }), scss: ExtractTextPlugin({loader: 'sass-loader' })} : { css: 'css-loader', scss: `css-loader!sass-loader?includePaths[]=${join(__dirname, '../node_modules')}` }
          }
        },
        {
          test: /\.js$/,
	...
	{
          test: /\.scss$/,
	  loader: !isDev ? ExtractTextPlugin.extract({ fallbackLoader: 'style', loader: 'css-loader!sass-loader' }) : "css-loader!sass-loader"
        },
        {
